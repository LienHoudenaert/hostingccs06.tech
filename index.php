...
?>
    ...
    <div class="container-fluid">
        ...
        <div><p>Welkom <b> <?php echo $namesession; ?></b> op ons hosting platform.
        <br> Links in de navigatie bar vind u de informatie die u nodig heeft voor FTP & Database beheer met PHPMyAdmin.
        ...
        <h5>Support</h5>
        <p>Mocht u hulp nodig hebben na het lezen van de documentatie, twijfel niet om contact op te nemen met onze support. <br>
        Rechts bovenaan ziet u een grijs vraagtekentje, hier kan je hulp vragen, bugs melden en terecht voor algemene vragen en opmerkingen. <br>
